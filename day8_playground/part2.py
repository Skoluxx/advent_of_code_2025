...
def main():
    ...
    print(distances[closest][0], distances[closest][1])
    print(idx)
    print(len(curcuits))
    ...
    nums = [distances[closest][0].get_x(), distances[closest][1].get_x()]
    print(f'Product of the X coordinates of the last two junction boxes needed to connect: {math.prod(nums)}')
main()